class zcl_lc_adv2021 definition
  public
  create public .
  ...
  public section.
    ...
    constants g_path type string value 'C:\temp\ADVENTOFCODE' ##NO_TEXT.
...
CLASS ZCL_LC_ADV2021 IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_LC_ADV2021->GET_INPUT_FILENAME
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method ZCL_LC_ADV2021->IMPORT_DATA
* +-------------------------------------------------------------------------------------------------+
* | [--->] I_FILENAME                     TYPE        STRING
* | [<---] ET_DATA                        TYPE        YT_STRING_TABLE
* | [<-()] R_SUBRC                        TYPE        I
